        ...
        <form @submit.prevent="handleSubmit()">
            ...
            <div class="my-4 flex-col items-center gap-5 flex-wrap">
                ...
                <div>
                    ...
                    <div>
                        <input type="text" name="MICRcode" id="MICRcode" maxlength="25" class="block w-[350px] h-10 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6" placeholder="Bank’s MICR Code"  v-model="MICRcode" @input="keyPressAlphaNumericMicr" />
                     </div>
                     <div class="h-5"></div>
                </div>
            </div>
            ...
            <div class="my-4  items-center gap-5 flex-wrap">
                <div >
                    ...
                    <div>
                        <input type="text"  maxlength="15" name="accountNo" id="accountNo" class="pw block w-[350px] h-10 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"  autocomplete="off" v-model="accountNumber" placeholder="Bank Account Number" @input="keyPressAlphaNumericAcc"/>
                    </div>
                    <div class="h-4">
                ...
                <div>
                    ...
                    <div>
                        <input type="text" name="reAccountNo" id="reAccountNo" class="block w-[350px] h-10 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"  @paste.prevent @keyup="clrMisMatchErr" placeholder="Bank Account Number" maxlength="15" v-model="reEnterAccountNumber" autocomplete="off" @input="keyPressAlphaNumericReAcc" />
                    </div>
                    <div class="h-4">
