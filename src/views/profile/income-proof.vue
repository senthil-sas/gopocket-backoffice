            ...
            <fieldset class="mt-4">
              <div class="space-y-4 sm:flex sm:items-center sm:space-x-10 sm:space-y-0">
                <div v-for="confirmation in confirmations" :key="confirmation.id" class="flex items-center">
                  <input v-model="confirmationAccept" :value="confirmation.title"  :id="confirmation.id" name="notification-method" type="checkbox" class="h-4 w-4 border-gray-300 accent-[#3977de] cursor-pointer" />
