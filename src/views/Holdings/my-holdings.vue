<template>
    <div class="h-[calc(100vh-96px)] overflow-y-auto " v-if="!getLoader">
     <!-- <holdings_widget /> -->
        <table  v-if="getHoldingsData && getHoldingsData.length < 6" id="holdings_table" class="w-full rounded-b border-t !border-b border-[#ededed] dark:border-[#232325] relative mt-[1px]" >
