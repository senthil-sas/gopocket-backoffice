    ...
    <div v-if="isBox && ($route.path == '/dashboard' || $route.path == '/holdings' || $route.path == '/profile')">
      <box class="w-full py-[40px] px-[24px] ">
        ...
        <div class="flex mt-4">
          ...
          <div class="flex pl-5">
            <icon name="male" height="20" width="20"
              v-if="getProfileData.gender == 'MALE' || getProfileData.gender == 'Male'" />
            <icon name="female" height="20" width="20"
              v-if="getProfileData.gender == 'FEMALE' || getProfileData.gender == 'Female'" />
        ...
        <div class="flex mt-4 gap-4 items-center">
          ...
          <span class="ml-auto cursor-pointer" @click="updateEmailOrMobile('email')">
        ...
        <div class="flex mt-4 gap-4 items-center">
          ...
          <span class="ml-auto cursor-pointer" @click="updateEmailOrMobile('mobile')">
            <icon name="edit" height="16" width="16" />
          </span>
        </div>
        <div class="h-5"></div>
        <div class="flex mt-4">
          ...
          <span class="ml-auto cursor-pointer" @click="getDigioLink(val)">
            <icon name="edit" height="16" width="16" />
          </span>
